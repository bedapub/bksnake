...
A haplotype map is a collection of "blocks" of SNPs which are in tight linkage with SNPs of the same block and low linkage with SNPs of different blocks (see [Javed et al., 2020])(https://doi.org/10.1038/s41467-020-17453-5). Here, we utilize fingerprint maps from [naumanjaved on github](https://github.com/naumanjaved/fingerprint_maps). In order to use this features, set the config file parameter `crosscheck_fingerprints: True`.
